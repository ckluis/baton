...
| &nbsp;&nbsp;6.3 | 6.3. Append-only lists are directories of rows | [`rule-6-3-append-only-lists-are-directories-of-rows.md`](../rules/rule-6-3-append-only-lists-are-directories-of-rows.md) |
